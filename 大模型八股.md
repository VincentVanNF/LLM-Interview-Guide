...
- pre-normalization:RMSNorm (激活函数/残差)
  - 不需要计算均值和方差，只做缩放。
  
    ![image-20250813222141594](https://s2.loli.net/2025/08/13/UKmwFaPngeXCxvH.png)
...
- SwiGLU激活函数
  ...
  <img src="https://s2.loli.net/2025/08/13/oibeAw5cnKFsITU.png" alt="image-20250813222619522" style="zoom: 67%;" />

  ![](https://s2.loli.net/2025/08/12/3qsxzTGdn7FlUpf.png)
